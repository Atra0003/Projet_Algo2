...
class Bulb {
    ...
    public Bulb(ArrayList<Integer> vect, int nbr_interup){
...
public class MaxNbrLightBulbsLit {

    private ArrayList<Integer> vect_interupteurs = new ArrayList<Integer>();
    private ArrayList<Bulb> vect_ampoules = new ArrayList<Bulb>();
    private int nbr_interup;
    private int nbr_max_ampoules_allumees = 0;


    public MaxNbrLightBulbsLit(ArrayList<ArrayList<Integer>> instnce_prblm){
        ...
        for(ArrayList<Integer> buff : instnce_prblm){vect_ampoules.add(new Bulb(buff, nbr_interup));} // initialise le vecteur d'ampoules
    }
    int determiner_nbr_ampoules_allumees(){ // determine le nombre d'ampoule allumeé pour une configuration donneé des etats des interups
        ...
        for(Bulb ampoule_crte : vect_ampoules){ // parcourt toutes les ampoules et pour chaque ampoule verifie si elle est allumeé
